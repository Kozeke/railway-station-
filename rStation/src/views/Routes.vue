    ...
    <div class="row menu-items">
      ...
      <div class="menu-data row col-sm-9">
        <div class="station-form">
          <input
            type="button"
            class="btn btn-danger add-station"
            value="Add Station"
          />
          <input
            type="button"
            ...
            <div class="row">
              ...
              <div class="form-group col-4">
                <div class="col-sm-12">
                  ...
                  <input
                    :class="{ active: hasfocus == 2 }"
                    @focusin="focusIn(2)"
                    @focusout="focusOut(2)"
                    type="text"
                    id="stationLatitute"
                    class="form-control"
                    name="stationLatitute"
                    placeholder="73.1234"
...
export default {
  ...
  methods: {
    init(value) {
      ...
      GoogleMapsLoader.load(function(google) {
        ...
        stations.forEach(station => {
          ...
          google.maps.event.addDomListener(station, "click", function() {
            ...
            if (changeStation) {
              document
                ...
                .setAttribute("value", station.city);
              document
                .getElementById("stationLatitute")
                .setAttribute("value", station.lat);
              document
                .getElementById("stationLongitude")
                .setAttribute("value", station.lng);
            }
            var flightPath = new google.maps.Polyline({
              path: clickedCoords,
              geodesic: true,
          ...
          (station.map = map), (station.position = position);
    ...
    editData(value) {
      //   this.clickedRoutes.routes.push({
      //     lat: lat,
      //     lng: long,
      //     city: name
      //   });
      ...
      //     });
      //   });
      //   console.log(clickedRoutes.routes);
      //   if (localStorage.allRoutes) {
      //     allRoutes = JSON.parse(localStorage.getItem("allRoutes"));
      //   }
      //   allRoutes.push(routes);
