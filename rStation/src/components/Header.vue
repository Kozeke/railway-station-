      ...
      <div class="col-12 h-100">
        <nav class="h-100 navbar navbar-expand-lg">
          <a class="navbar-brand" @click="$router.push('/')"
            ><img src="../assets/img/core-img/train1.png" alt=""
          /></a>
          <button
          ...
          <div class="collapse navbar-collapse" id="dorneNav">
            ...
            <div class="dorne-signin-btn" v-if="isUser">
              <mdb-dropdown class="user-dropdown">
                <mdb-dropdown-toggle
                  class="user-btn text-capitalize"
                  slot="toggle"
                ...
                <mdb-dropdown-menu>
                  ...
                  <mdb-dropdown-item
                    ...
                    ><i class="fas fa-history"></i>Bookings</mdb-dropdown-item
                  >
                  <mdb-dropdown-item
                    class="user-li"
                    @click="$router.push('/settings')"
                    ><i class="fas fa-user-cog"></i>Settings</mdb-dropdown-item
                  >
                  <div class="dropdown-divider"></div>
                  <mdb-dropdown-item class="user-li" @click="logOut()"
                    ><i class="fas fa-power-off"></i>Log out</mdb-dropdown-item
                  >
                </mdb-dropdown-menu>
              </mdb-dropdown>
            </div>
